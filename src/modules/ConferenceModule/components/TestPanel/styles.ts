...
export const styles = {
  ...
  statCard: {
    ...
    padding: "14px 8px",
    borderRadius: "10px",
    border: `1.5px solid rgba(84,107,65,0.2)`,
    backgroundColor: "rgba(84,107,65,0.04)",
  },
  statValue: {
  ...
  newTestButton: {
    ...
    padding: "12px",
    borderRadius: "10px",
    border: `1.5px solid rgba(84,107,65,0.35)`,
    backgroundColor: "transparent",
    color: mainPalette.primary,
    fontSize: "14px",
    fontWeight: 600,
